...
error_log("Betreuer.php - Session role: '" . ($_SESSION['role'] ?? 'NOT SET') . "'");
error_log("Betreuer.php - Full session: " . print_r($_SESSION, true));

if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'betreuer') {
    error_log("Betreuer.php - Role check failed, redirecting to index.html");
