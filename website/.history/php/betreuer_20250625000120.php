...
<body>
    ...
    <div class="subnav">
        <a href="?page=overview&patient=<?= $patientID ?>" class="<?= $page === 'overview' ? 'active' : '' ?>">Übersicht</a>
        <?php if ($patientID): ?>
                ...
                <div class="patient-card">
                    ...
                    <?php else: ?>
                        <ul class="patient-list">
                            <?php foreach ($patients as $patient): ?>
                                <li><a href="?page=patient&patient=<?= $patient['patientid'] ?>"><?= htmlspecialchars($patient['name']) ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    <?php endif; ?>
                </div>
                    ...
                    <form method="post">
                        ...
                        <div class="patient-params-row">
                            <div>
                                ...
                                <input type="text" id="blutdruck" name="blutdruck" class="input-field" value="<?= $healthData ? htmlspecialchars($healthData['blutdruck']) : '' ?>" placeholder="120/80">
                            </div>
                            <div>
                                <label class="label" for="temperatur">Temperatur (°C):</label>
                                <input type="number" id="temperatur" name="temperatur" step="0.1" class="input-field" value="<?= $healthData ? $healthData['temperatur'] : '' ?>" placeholder="36.5">
                            </div>
                            <div>
                                <label class="label" for="blutzucker">Blutzucker (mg/dl):</label>
                                <input type="number" id="blutzucker" name="blutzucker" class="input-field" value="<?= $healthData ? $healthData['blutzucker'] : '' ?>" placeholder="100">
                            </div>
                        </div>
