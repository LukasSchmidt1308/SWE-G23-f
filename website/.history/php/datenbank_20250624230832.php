...
try {
    ...
    $mysqli->exec("INSERT INTO Station (Name, Adresse) VALUES 
    ...
    $mysqli->exec("INSERT INTO Benutzer (Name, Rolle, Benutzername, Passwort, Kontaktdaten) VALUES 
    ...
    $mysqli->exec("INSERT INTO Betreuer (BenutzerID, StationID, MaxPatienten) VALUES 
        (3, 1, 5)"); // Maria Pflegerin assigned to Station A with max 5 patients
    
    // Insert sample Patient
    $mysqli->exec("INSERT INTO Patient (BenutzerID, Adresse, Geburtsdatum, Pflegeart, StationID, BetreuerID) VALUES 
